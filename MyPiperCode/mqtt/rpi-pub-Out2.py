...
if __name__ == '__main__':
	try:
		readData()
                ...
                Msg1 = str(sensor_data['temp'])
                Msg2 = str(sensor_data['humidity'])
                Msg3 = str(sensor_data['pressure'])
...
client1 = mqtt.Client("pub2") #create new instance
client2 = mqtt.Client("pub3") #create new instance
client3 = mqtt.Client("pub4") #create new instance
...
client3.connect(broker_address) #connect to broker

print("Publishing message: %s to topic: %s" % (Msg1, Topic1))
print("Publishing message: %s to topic: %s" % (Msg2, Topic2))
print("Publishing message: %s to topic: %s" % (Msg3, Topic3))
client1.publish(Topic1,Msg1)
client2.publish(Topic2,Msg2)
client3.publish(Topic3,Msg3)
